  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <div className="footer--items">
          <ul>
            ...
            <li>
              <a
                href="https://www.tiktok.com/@reiyaard"
            ...
            <li>
              <a
                href="https://www.instagram.com/reinds__"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Reinds Organizer</p>
